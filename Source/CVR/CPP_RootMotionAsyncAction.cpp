...
#include "CPP_RootMotionAsyncAction.h"
#include "Engine.h"

// This function is just a factory that creates a UCPP_RootMotionAsyncAction instance.
UCPP_RootMotionAsyncAction* UCPP_RootMotionAsyncAction::RootMotionAsyncAction(
    ...
    bool bEnableGravity)
{
    ...
    UCPP_RootMotionAsyncAction* Node = NewObject<UCPP_RootMotionAsyncAction>();
    Node->ContextWorld = ContextWorld;
    Node->CharacterMovement = CharacterMovement;
    Node->AsyncActionTag = ActionInstanceTag;
...
void UCPP_RootMotionAsyncAction::Activate()
{
    if (const UWorld* World = GetWorld())
    {
        ...
        if (CharacterMovement) {
            ...
            TimerManager.SetTimer(
                OngoingTimer,
                FTimerDelegate::CreateLambda([WeakThis = TWeakObjectPtr<UCPP_RootMotionAsyncAction>(this)]()
                    {
